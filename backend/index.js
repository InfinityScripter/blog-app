...
// CORS middleware
app.use(cors({
    origin: "https://sh0ny.online", // Укажите ваш домен вместо '*'
    methods: "GET,POST,PUT,DELETE,PATCH,OPTIONS",
    allowedHeaders: "Content-Type,Authorization,Origin,Accept,X-CSRF-Token",
    credentials: true, // Если нужны куки/заголовки авторизации
}));

// Middleware для preflight-запросов (OPTIONS)
app.options("*", (req, res) => {
    res.set("Access-Control-Allow-Origin", "https://sh0ny.online");
    res.set("Access-Control-Allow-Methods", "GET,POST,PUT,DELETE,PATCH,OPTIONS");
    res.set("Access-Control-Allow-Headers", "Content-Type,Authorization,Origin,Accept,X-CSRF-Token");
